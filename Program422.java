...
class DBMS
{
    ...
    {
        System.out.println("Data from the student table is : "+str);
    ...
    public void SelectSum()
    {
        ...
        System.out.println("Summation of marks colomn is :"+iSum);
    }
    ...
    public void SelectAvg()
    {
        ...
        System.out.println("Summation of marks colomn is :"+(float)((float)iSum/(float)iCnt));
    }
    ...
    public void SelectMax()
    {
        ...
        System.out.println("Maximum of marks colomn is :"+iMax);
    }
    ...
    public void SelectMin()
    {
        ...
        System.out.println("Minimum of marks colomn is :"+iMin);
    }
    ...
    public void SelectStarFromName(String str)
    {
        ...
        System.out.println("info of all stu with the name : "+str);
        while(temp != null)
        {
    ...
    // 10.update student set City = "___" where Rno =___;
    public void UpdateCity(int no,String str)
    {
        node temp = first;

        System.out.println("Change the city name of Roll no: "+no);
        while(temp != null)
        {
            if(temp.Rno == no)
            {
    ...
    public void DeleteFrom(int no)
    {
        ...
        System.out.println("delete roll no : "+no);
        //if LL is empty
        if(temp == null)
        {
            return;
...
class Program422
{
    public static void main(String Arg[])
    {
        ...
        obj.InsertIntoTable("Rukmini","Pandarpur",77);
        obj.SelectStarFrom();
    }
}
